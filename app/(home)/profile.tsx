...
const Profile = () => {
  ...
  const stateWiseDistrict = states.filter((states) => states.stateName === selectedState)
    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: 20 }} keyboardShouldPersistTaps="handled">
      <View style={styles.container}>
        ...
        <View style={styles.infoContainer}>
          ...
          <CustomSelect label='State' data={states} selected={selectedState} setSelectedValue={setSelectedState} placeholderText={"Select State"} editable={isEditing} />
          <CustomSelect label='District' data={stateWiseDistrict[0]?.districts} selected={selectedDistrict} setSelectedValue={setSelectedDistrict} placeholderText={"Select District"} editable={isEditing} />
